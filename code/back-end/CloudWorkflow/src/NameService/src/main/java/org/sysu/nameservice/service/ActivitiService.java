...
import org.sysu.nameservice.loadbalancer.rule.activiti.ServerGroupGarbageCollectionJob;
...
public class ActivitiService {
    ...
    public void serverGroupGarbageCollection() {
        try {
            ServerGroupGarbageCollectionJob job = new ServerGroupGarbageCollectionJob();
            job.schedulerJob(workflowLoadBalancerClient.getServiceIdToLoadBalancer());
        } catch (SchedulerException e) {
            e.printStackTrace();
        } catch (InterruptedException e) {
